...
func TestUpdateBookmark(t *testing.T) {
	...
	must(t, s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Old", URL: "https://old.com", Tags: []string{"old"}}))
...
func TestDeleteBookmark(t *testing.T) {
	...
	must(t, s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Delete Me", URL: "https://del.com"}))
...
func TestGetBookmarksByTag(t *testing.T) {
	...
	must(t, s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Go", URL: "https://go.dev", Tags: []string{"go"}}))
	must(t, s.CreateBookmark(&model.Bookmark{ID: "2", Title: "Rust", URL: "https://rust-lang.org", Tags: []string{"rust"}}))
	must(t, s.CreateBookmark(&model.Bookmark{ID: "3", Title: "Go HTMX", URL: "https://htmx.org", Tags: []string{"go", "htmx"}}))
...
func TestSearchBookmarks(t *testing.T) {
	...
	must(t, s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Go Blog", URL: "https://go.dev/blog"}))
	must(t, s.CreateBookmark(&model.Bookmark{ID: "2", Title: "Rust News", URL: "https://rust-lang.org"}))
...
func TestGetBookmarksByFolder(t *testing.T) {
	...
	must(t, s.CreateFolder(&model.Folder{ID: "f1", Name: "Work"}))
	must(t, s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Work Link", URL: "https://work.com", FolderID: "f1"}))
	must(t, s.CreateBookmark(&model.Bookmark{ID: "2", Title: "Personal", URL: "https://personal.com"}))
