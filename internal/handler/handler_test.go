...
func TestListBookmarks_FullPage(t *testing.T) {
	...
	_ = s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Test", URL: "https://test.com"})
...
func TestSearchBookmarks(t *testing.T) {
	h, s := setupTestHandler(t)
	_ = s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Go Blog", URL: "https://go.dev"})
	_ = s.CreateBookmark(&model.Bookmark{ID: "2", Title: "Rust News", URL: "https://rust-lang.org"})
...
func TestFilterByTag(t *testing.T) {
	h, s := setupTestHandler(t)
	_ = s.CreateBookmark(&model.Bookmark{ID: "1", Title: "Go", URL: "https://go.dev", Tags: []string{"go"}})
	_ = s.CreateBookmark(&model.Bookmark{ID: "2", Title: "Rust", URL: "https://rust-lang.org", Tags: []string{"rust"}})
